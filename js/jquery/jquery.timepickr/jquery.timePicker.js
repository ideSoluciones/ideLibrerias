...
(function($){
  ...
  $._timePicker = function(elm, settings) {
    ...
    var $tpDiv = $('<div class="time-picker'+ (settings.show24Hours ? '' : ' time-picker-12hours') +' ui-widget-header"></div>');
    var $tpList = $('<ul></ul>');
    ...
    $tpDiv.appendTo('body').css({'top':elmOffset.top+22, 'left':elmOffset.left+17}).hide();
