package ideLibrerias{
	...
	public class CComunicador extends Sprite{
		...
		public function CComunicador(_padre:Object, nombreProyecto: String, direccionBase:String="http://idesoluciones.com/ideProyectos/", direccionPedidos:String="q=1") {
			this.padre=_padre;
		...
		private function login():void{
			...
			trace(" * 2");
			myLoader.load(new URLRequest("http://192.168.1.42/~jag2kn/hg/ASTrading/?q=1"))
			trace(" * 3");
			...
			function onLoad(ev:Event):void{
				...
				trace(" * * 2");
				myLoader1.load(new URLRequest("http://192.168.1.42/~jag2kn/hg/ASTrading/?q=1/6&Usuario=adminAST&Pass=1234"))
				trace(" * * 3");
