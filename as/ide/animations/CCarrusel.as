package ide.animations{
	...
	public class CCarrusel {
		...
		public function CCarrusel(_nodo:XML, _objeto:Object){
			this.nodo=_nodo;
			this.objeto=_objeto;
			this.objeto.propiedades.carrusel=this;
				...
				(
					objeto,
					{
						...
						onComplete:function():void {
							objeto.x=50;
							objeto.propiedades.carrusel.animacion();
							/*
							trace("Termino "+this);
