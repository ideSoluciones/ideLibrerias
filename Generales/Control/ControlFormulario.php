...
class ControlFormulario{
	...
	public static function addForm($nodo, $parametros=array()){
	...
	public static function addSend($nodo,$parametros=array()){
	...
	public static function add($nodo, $parametros=array()){
